...
---Saves the state in the global _G.NvimKiroPlugin.state object.
---
---@private
function state:save()
    log.debug("state.save", "saving state globally to _G.NvimKiroPlugin.state")

    _G.NvimKiroPlugin.state = self
end
...
---Whether the NvimKiroPlugin is enabled or not.
---
